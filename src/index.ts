...
export { ContextIR, buildContextIR } from './parser/ir';
export { McpServer, PropertyDefinition, ToolDefinition, ResourceDefinition, PromptDefinition } from './mcp/framework';
